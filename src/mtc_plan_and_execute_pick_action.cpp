...
#include <mtc_ros2/action/mtc_plan_and_execute_pick.hpp>
...
using PlanAndExecute = mtc_ros2::action::MTCPlanAndExecutePick;
...
int main(int argc, char** argv)
{
  ...
  auto node = std::make_shared<mtc_ros2::MtcPlanAndExecutePickActionNode>();
